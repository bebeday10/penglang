...
def add_request(request_name: str, name: str, mode: str, item: dict, amount: int, internal_name: str , log: bool =False):
    if not ct.requests.get(request_name) == None:
...
def accept_request(request_name: str, name: str, log: bool=False, remove_request: bool=True):
    if ct.requests.get(request_name) == None:
